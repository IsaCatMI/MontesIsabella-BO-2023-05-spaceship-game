...
from game.utils.constants import BG, ICON, SCREEN_HEIGHT, SCREEN_WIDTH, TITLE, FPS, FONT_STYLE, DEFAULT_TYPE, SHIELD_1_TYPE, GO
...
class Game:
    ...
    def show_menu(self):
        ...
        if self.death_counter.counter > 0:
            ...
            #self.menu.update_message(f'Score: {self.score} Max Score: {self.max_score} Total Deaths: {self.death_counter}')

            #*icon = pygame.transform.scale((ICON), (80, 120))
            #*self.screen.blit(icon, ((SCREEN_WIDTH / 2) - 40, (SCREEN_HEIGHT / 2) - 150))
            #*self.score.draw(self.screen, SCREEN_WIDTH / 2, (SCREEN_HEIGHT / 2 + 50))
            #*self.highest_score.draw(self.screen, SCREEN_WIDTH / 2, (SCREEN_HEIGHT / 2) + 100)
            #*self.death_counter.draw(self.screen, SCREEN_WIDTH / 2, (SCREEN_HEIGHT / 2) + 150) 
            #*self.death_counter.draw(self.screen, SCREEN_WIDTH / 2, 200)
            icon = pygame.transform.scale((ICON), (80, 120))
            self.screen.blit(icon, ((SCREEN_WIDTH / 2) - 40, (SCREEN_HEIGHT / 2) - 150))
            ...
            #borrar dos filas de abajo
            go = pygame.transform.scale((GO), (500, 120))
            #*self.screen.blit(go, ((SCREEN_WIDTH / 2) - 240, (SCREEN_HEIGHT / 2) -250))
    ...
    #def increase_score(self):
        #self.score += 1
        #if self.player.power_up_type == SHIELD_1_TYPE:
            #self.score +=10
